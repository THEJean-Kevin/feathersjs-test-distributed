...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { stripSlashes } from '@feathersjs/commons';
...
export default function init (options) {
  return function () {
    ...
    app.cote = (distributionOptions.cote ? <span class="branch-0 cbranch-no" title="branch not covered" >makeCote(distributionOptions.cote) : makeCote());</span>
...
&nbsp;
    ...
    app.serviceSubscriber.on('service', serviceDescriptor =&gt; {
      ...
      if (service) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (service instanceof RemoteService) {
<span class="cstat-no" title="statement not covered" >          debug('Already registered service as remote on path ' + serviceDescriptor.path);</span>
        } else {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Wed Apr 10 2019 10:20:43 GMT+0200 (Paris, Madrid (heure d’été))
</div>
</div>
